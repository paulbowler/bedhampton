<html>
	<head>
		...
		<title>Modern Pianos for Sale - Bedhampton Piano Shop</title>
	</head>
	<body>
		<div id="wrapper">
			<div id="header"></div>
			...
			<div id="main">
				<div id="content">
					<div class="panel">
						<div class="portlet">
							<h1>Modern Pianos for Sale</h1>
							<p>Here are the modern pianos we currently have for sale. Our stock is constantly changing
							so make sure you come back regularly to view our latest models.</p>
						</div>
						<g:each in="${pianos.channel.item}" var="piano">
							<g:if test="${piano.title.toString().contains('odern')}">
